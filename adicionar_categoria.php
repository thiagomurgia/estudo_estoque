...
<th style="text-align: center;">
      <a href="_deletar_categoria.php?id=<?php echo $id_categoria ?>"><button type="button" class="btn btn-outline-danger bt-sm" style="color:#fff;" role="button"><i class="fas fa-trash-alt"></i><small>&nbsp;Excluir</small></button></a>
      </th>
...
<div class="container" id="containerCategorias">
  ...
  <div class="form-group">
      ...
      <input type="text" name="categoria"class="form-control" placeholder="Insira a nova categoria">
    </div>
